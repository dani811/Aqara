...
| Section | What's here |
| --- | --- |
| [`architecture.md`](architecture.md) | System overview: the reconnection pipeline end to end. |
| [`protocol/`](protocol/README.md) | The reverse-engineered BLE + cloud protocol reference. |
| [`tutorials/`](tutorials/README.md) | Step-by-step, reproducible guides. |
...
was cracked, read [`journey/`](journey/README.md).
