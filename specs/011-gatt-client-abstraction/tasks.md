...
- [X] T001 Define `GattClient` Protocol (`write_gatt_char`, `start_notify`, `stop_notify`) in `aqara_ble/gatt.py`.
...
- [X] T004 Export `GattClient` from `aqara_ble/__init__.py` (`__all__`).
